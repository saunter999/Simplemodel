...
if __name__=='__main__':
   ...
   # print qx,qx.shape
	...
	#	print>>f,q1,q2,Eig[0].real,Eig[1].real
                Eig1[ind1,ind2]=Eig[0].real
                Eig2[ind1,ind2]=Eig[1].real
    ax = plt.axes(projection='3d')
    figure(1)
    ax.plot_surface(qx, qy, Eig1, rstride=1,cstride=1,linewidth=0,cmap=cm.coolwarm, antialiased=False)
    ax.plot_surface(qx, qy, Eig2, rstride=1,cstride=1,linewidth=0,cmap=cm.coolwarm, antialiased=False)
